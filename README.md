...
Results when searching for the word 'weapon' so that it also searches for the keywords in the query and the 5 most similar words according to the ```glove-twitter-25``` model.
